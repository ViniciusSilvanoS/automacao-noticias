...
def businessinsider_empresa():
    try:
        url = "https://www.businessinsider.com/enterprise"
...
def businessinsider_inovacao():
    try:
        url = "https://www.businessinsider.com/innovation"
        response = requests.get(url)
        html = response.content
