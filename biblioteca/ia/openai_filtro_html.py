        ...
        completion = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": f'Capte as informações do arquivo HTML e retorne no formato json com a URL em formato absoluto.'
                                            ...
                                            f'\nResponda no português brasileiro, caso o titulo esteja inglês, traduza para português.'
                                            f'\nHTML: \n{html}\n\nUse o template a seguir: {schema}\n'
                                            f'\n- titulo: Deve ser pego o tópico da notícia'
                                            f'\n- fonte: Deve fornecer a fonte do site que está sendo acessado. Exemplos de fontes incluem: Microsoft, TechCrunch, Business Insider.'
